...
export const deliveryList = [
    {id: 0, address: 'Бишкек, улица Табышалиева, 57', checked: true, delivery: 'courier'},
    {id: 1, address: 'Бишкек, улица Жукеева-Пудовкина, 77/1', checked: false, delivery: 'courier'},
    {id: 2, address: 'Бишкек, микрорайон Джал, улица Ахунбаева Исы, 67/1', checked: false, delivery: 'courier'},
    {
        id: 3,
    ...
    {id: 5, address: 'г. Бишкек, улица Табышалиева, д. 57', checked: false, rate: '4.99', delivery: 'pick-up'}
];